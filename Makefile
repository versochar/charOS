...
test-de64:
	$(CC) -iquote include $(K64_DIR)/panel64.c $(K64_DIR)/wmde64.c \
		...
		$(K64_DIR)/ctxmenu64.c $(K64_DIR)/gamed64.c $(K64_DIR)/controller64.c $(K64_DIR)/fps64.c $(K64_DIR)/perfhud64.c $(K64_DIR)/replay64.c $(K64_DIR)/achievement64.c $(K64_DIR)/mod64.c $(K64_DIR)/cloudsave64.c $(K64_DIR)/anticheat64.c $(K64_DIR)/userns64.c $(K64_DIR)/seccomp64.c $(K64_DIR)/mountns64.c $(K64_DIR)/pidns64.c $(K64_DIR)/netns64.c $(K64_DIR)/cgroup64.c $(K64_DIR)/apparmor64.c $(K64_DIR)/flatpak64.c $(K64_DIR)/runtime64.c $(K64_DIR)/liveiso64.c $(K64_DIR)/installer64.c $(K64_DIR)/partition64.c $(K64_DIR)/luks64.c $(K64_DIR)/bootloader64.c $(K64_DIR)/netinstall64.c $(K64_DIR)/pxe64.c $(K64_DIR)/autoinstall64.c $(K64_DIR)/recovery64.c $(K64_DIR)/release64.c $(K64_DIR)/changelog64.c $(K64_DIR)/manpages64.c $(K64_DIR)/apidocs64.c $(K64_DIR)/website64.c $(K64_DIR)/cicd64.c $(K64_DIR)/paketdepo64.c $(K64_DIR)/security64.c $(K64_DIR)/lts64.c $(K64_DIR)/releasev1_64.c tests/host/test_de64.c -o /tmp/test_de64
	/tmp/test_de64
