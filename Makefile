...
KERNEL_SRCS = $(KERNEL_DIR)/kernel.c \
              ...
              $(KERNEL_DIR)/drivers/xhci.c \
               ...
               $(KERNEL_DIR)/drivers/pcm.c \
               $(KERNEL_DIR)/drivers/hdaverb.c \
...
# 27.4: sürüm bilgisi derleme anında gömülür (yalnızca version.o etkilenir)
CHAROS_VER := $(shell head -1 VERSION 2>/dev/null || echo "charOS dev")
CHAROS_COMMIT := $(shell git rev-parse --short HEAD 2>/dev/null || echo nogit)
$(BUILD_DIR)/core/version.o: CFLAGS += -DCHAROS_VERSION_STR='"$(CHAROS_VER)"' -DCHAROS_VERSION_COMMIT='"$(CHAROS_COMMIT)"'
...
# 26.5: gercek prof.c host testi (sahte tick ile deterministik)
test-prof26:
	$(CC) -iquote include kernel/core/verify.c kernel/core/prof.c tests/host/test_prof26.c -o /tmp/test_prof26
	/tmp/test_prof26

# 27.5: gercek version.c host testi (-D degerleri birebir)
test-version27:
	$(CC) -iquote include -DCHAROS_VERSION_STR='"test-27"' -DCHAROS_VERSION_COMMIT='"abc1234"' kernel/core/version.c tests/host/test_version27.c -o /tmp/test_version27
	/tmp/test_version27

# 28.5: gercek selftest.c host testi (stub yok)
test-selftest28:
	$(CC) -iquote include kernel/core/verify.c kernel/test/selftest.c tests/host/test_selftest28.c -o /tmp/test_selftest28
	/tmp/test_selftest28

# 29.5: gercek doc.c host testi (stub yok)
test-doc29:
	$(CC) -iquote include kernel/core/verify.c kernel/core/doc.c tests/host/test_doc29.c -o /tmp/test_doc29
	/tmp/test_doc29

# 30.5: gercek abi.c host testi (stub yok)
test-abi30:
	$(CC) -iquote include kernel/core/verify.c kernel/core/doc.c kernel/core/abi.c tests/host/test_abi30.c -o /tmp/test_abi30
	/tmp/test_abi30
...
test-de64:
	$(CC) -iquote include $(K64_DIR)/panel64.c $(K64_DIR)/wmde64.c \
		...
		$(K64_DIR)/ctxmenu64.c $(K64_DIR)/gamed64.c $(K64_DIR)/controller64.c $(K64_DIR)/fps64.c $(K64_DIR)/perfhud64.c $(K64_DIR)/replay64.c $(K64_DIR)/achievement64.c $(K64_DIR)/mod64.c $(K64_DIR)/cloudsave64.c $(K64_DIR)/anticheat64.c $(K64_DIR)/userns64.c $(K64_DIR)/seccomp64.c $(K64_DIR)/mountns64.c $(K64_DIR)/pidns64.c $(K64_DIR)/netns64.c $(K64_DIR)/cgroup64.c $(K64_DIR)/apparmor64.c $(K64_DIR)/flatpak64.c $(K64_DIR)/runtime64.c $(K64_DIR)/liveiso64.c $(K64_DIR)/installer64.c $(K64_DIR)/partition64.c $(K64_DIR)/luks64.c $(K64_DIR)/bootloader64.c $(K64_DIR)/netinstall64.c $(K64_DIR)/pxe64.c $(K64_DIR)/autoinstall64.c $(K64_DIR)/release64.c $(K64_DIR)/changelog64.c $(K64_DIR)/manpages64.c $(K64_DIR)/apidocs64.c $(K64_DIR)/website64.c $(K64_DIR)/cicd64.c $(K64_DIR)/paketdepo64.c $(K64_DIR)/security64.c $(K64_DIR)/lts64.c $(K64_DIR)/releasev1_64.c $(K64_DIR)/secureboot64.c $(K64_DIR)/tpm64.c $(K64_DIR)/advmem64.c $(K64_DIR)/proc64.c $(K64_DIR)/sched64.c $(K64_DIR)/ipc64.c $(K64_DIR)/sync64.c $(K64_DIR)/drvhal64.c $(K64_DIR)/pcihal64.c $(K64_DIR)/blk64.c $(K64_DIR)/part64.c $(K64_DIR)/vfs64.c $(K64_DIR)/jrnl64.c $(K64_DIR)/fscrypt64.c $(K64_DIR)/virt64.c $(K64_DIR)/net64.c $(K64_DIR)/tcp64.c $(K64_DIR)/netsec64.c $(K64_DIR)/netadv64.c $(K64_DIR)/secfw64.c $(K64_DIR)/recovery64.c $(K64_DIR)/watchdog64.c $(K64_DIR)/crash64.c $(K64_DIR)/update64.c $(K64_DIR)/pkgmgr64.c $(K64_DIR)/repo64.c $(K64_DIR)/secupd64.c $(K64_DIR)/isoimg64.c $(K64_DIR)/installfw64.c $(K64_DIR)/parttool64.c $(K64_DIR)/luksop64.c $(K64_DIR)/blcfg64.c $(K64_DIR)/nbp64.c $(K64_DIR)/recenv64.c $(K64_DIR)/ctr64.c $(K64_DIR)/fpsb64.c $(K64_DIR)/landlk64.c $(K64_DIR)/secpol64.c $(K64_DIR)/kprot64.c $(K64_DIR)/mitig64.c $(K64_DIR)/fuzz64.c $(K64_DIR)/sana64.c $(K64_DIR)/dyna64.c $(K64_DIR)/comp64.c $(K64_DIR)/ent64.c $(K64_DIR)/ha64.c tests/host/test_de64.c -o /tmp/test_de64
	/tmp/test_de64
