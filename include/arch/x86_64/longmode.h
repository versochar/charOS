...
/* --- 11A: Block Devices (davranis modeli) --- */
int blk64_init(void);
...
/* --- 12A: Partition Manager (davranis modeli) --- */
...
/* --- 60A: Compliance Certifications (comp) --- */
